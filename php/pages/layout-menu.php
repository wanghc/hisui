...
<body class="hisui-layout">
    <div data-options="region:'west',border:false" style="width:200px;padding:15px 0 15px 15px;background-color: #cde6ff;" >
        <div id="mm"></div>
    </div>
    <div data-options="region:'center',border:false" style="padding: 15px;background-color: #cde6ff;">
            ...
            for(var i=1;i<4;i++){
                ...
                for (var j=1;j<(6-i);j++){
                    item.children.push({
                        ...
                        state:'open',
                        attributes:{
                            url:'index.php?page=layout-query-inside&version='+HISUIStyleCode,
                            count:(i==1&&j<=2)?j:0
                        }
                    })
