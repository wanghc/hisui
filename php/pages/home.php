        ...
        <div id="accd" class="hisui-accordion  accordion-gray" fit="true" data-options="border:false">
            <div title="基础" >
                <ul>
                    ...
                    <li><a href="javascript:void(0);" src="icon" class="api-navi-tab">图标(icon)</a></li>
                    <li><a href="javascript:void(0);" src="pic" class="api-navi-tab">插画(pic)</a></li>
                    <li><a href="javascript:void(0);"  src="tooltip" class="api-navi-tab">提示（tooltip）</a></li>
                    <li><a href="javascript:void(0);"  src="popover" class="api-navi-tab">泡芙提示（popover）</a></li>    
                    
                </ul>
            </div>
            <div title="布局" >   
                <ul>
                    <li><a href="javascript:void(0);" src="panel" class="api-navi-tab">面板(panel)</a></li>
                    <li><a href="javascript:void(0);" src="tab" class="api-navi-tab">页签(tab)</a></li>
                    <li><a href="javascript:void(0);" src="accordion" class="api-navi-tab">手风琴(accordion)</a></li>
                    <li><a href="javascript:void(0);" src="layout" class="api-navi-tab">五方布局(layout)</a></li>
                    <li><a href="javascript:void(0);" src="hstep" class="api-navi-tab">水平步骤(hstep)</a></li>
                    <li><a href="javascript:void(0);" src="vstep" class="api-navi-tab">纵向步骤(vstep)</a></li>
                    <li><a href="javascript:void(0);" target="_blank" src="layout-query" class="api-navi-tab">标准查询界面</a></li>
                    <li><a href="javascript:void(0);" target="_blank" src="layout-menu" class="api-navi-tab">左侧菜单布局</a></li>
                </ul>   
            </div>
            <div title="表单" >
                <ul>
                    <li><a href="javascript:void(0);" src="label" class="api-navi-tab">文本(label)</a></li>
                    <li><a href="javascript:void(0);" src="linkbutton" class="api-navi-tab">按钮(linkbutton)</a></li>
                    <li><a href="javascript:void(0);" src="menubutton" class="api-navi-tab">菜单按钮(menubutton)</a></li>
                    <li><a href="javascript:void(0);"  src="splitbutton" class="api-navi-tab">分割按钮(splitbutton)</a></li>
                    <li><a href="javascript:void(0);"  src="validatebox" class="api-navi-tab">验证框(validatebox)</a></li>
                    <li><a href="javascript:void(0);"  src="searchbox" class="api-navi-tab">查询框(searchbox)</a></li>
                    <li><a href="javascript:void(0);"  src="numberbox" class="api-navi-tab">数字框(numberbox)</a></li>
                    <li><a href="javascript:void(0);"  src="triggerbox" class="api-navi-tab">触发框(triggerbox)</a></li>
                    <li><a href="javascript:void(0);"  src="datebox" class="api-navi-tab">日期框(datebox)</a></li>
                    <li><a href="javascript:void(0);"  src="timespinner" class="api-navi-tab">时间框(timespinner)</a></li>
                    
                    <li><a href="javascript:void(0);"  src="combobox" class="api-navi-tab">下拉框(combobox)</a></li>
                    <li><a href="javascript:void(0);"  src="switchbox" class="api-navi-tab">开关(switchbox)</a></li>
                    <li><a href="javascript:void(0);"  src="checkbox" class="api-navi-tab">复选框(checkbox)</a></li>
                    <li><a href="javascript:void(0);"  src="radio" class="api-navi-tab">单选框(radio)</a></li>
                    <li><a href="javascript:void(0);"  src="filebox" class="api-navi-tab">文件框(filebox)</a></li>
                    <li><a href="javascript:void(0);"  src="keywords" class="api-navi-tab">关键字列表(keywords)</a></li>
            ...
            <div title="表格及树" >
                <ul>
                    <li><a href="javascript:void(0);" src="datagrid" class="api-navi-tab">表格(datagrid)</a></li>
                    <li><a href="javascript:void(0);" src="datagrid.scroll" class="api-navi-tab">表格滚动加载(scroll)</a></li>
                    <li><a href="javascript:void(0);" src="datagrid.edit" class="api-navi-tab">表格编辑(edit)</a></li>
                    <li><a href="javascript:void(0);" src="datagrid.celledit" class="api-navi-tab">单元编辑(celledit)</a></li>
                    <li><a href="javascript:void(0);" src="treegrid" class="api-navi-tab">树形表格(treegrid)</a></li>
                    <li><a href="javascript:void(0);" src="tree" class="api-navi-tab">树(tree)</a></li>
                    <li><a href="javascript:void(0);" src="menutree" class="api-navi-tab">菜单树(menutree)</a></li>
                    <li><a href="javascript:void(0);" src="combogrid" class="api-navi-tab">下拉表格(combogrid)</a></li>
                    <li><a href="javascript:void(0);" src="combotree" class="api-navi-tab">下拉树(combotree)</a></li>                    
                </ul>
            </div>
            <div title="窗口"> 
                 <ul>       
                    <li><a href="javascript:void(0);"  src="window" class="api-navi-tab">窗口(window)</a></li>
                    <li><a href="javascript:void(0);"  src="dialog" class="api-navi-tab">模态窗(dialog)</a></li>
                    <li><a href="javascript:void(0);"  src="messager" class="api-navi-tab">消息框(messager)</a></li>
                </ul>
            </div>
            <div title="极速系列"> 
                <ul>
                   <li><a href="javascript:void(0);"  src="lookup" class="api-navi-tab">放大镜(lookup)</a></li>
                   <li><a href="javascript:void(0);"  src="dateboxq" class="api-navi-tab">日期框(dateboxq)</a></li>
                   <li><a href="javascript:void(0);"  src="timeboxq" class="api-navi-tab">时间框(timeboxq)</a></li>
                   <li><a href="javascript:void(0);"  src="datetimeboxq" class="api-navi-tab">日期时间(datetimeboxq)</a></li>
               </ul>
           </div>
            <div title="测试"> 
                <ul>   
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $('.api-navi-tab').click(function() {
                ...
                var myhref = `index.php?version=${HISUIStyleCode}&page=${href}`;
                if (target=='_blank') {
