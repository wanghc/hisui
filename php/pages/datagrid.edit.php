...
<head>
	...
	<style>
		...
		.datagrid-cell.datagrid-editable input[type="checkbox"]{
			margin-top: 5px;
		}
	...
	<div class="use-prettyprint" prettyprintfor="#mydg1codehtml">
		...
		<tr>
			...
			<th data-options="field:'note',width:200,editor:{type:'textarea',options:{required:true,height:'60px'}}">说明(text)</th>
			...
			<th data-options="field:'active2',width:60,align:'center',editor:{type:'switchbox',options:{width:51,onClass:'primary',offClass:'gray',onText:'启用',offText:'禁用'}}">开关switchbox</th>
			
			<th data-options="field:'op',width:140,align:'center',formatter:function(val,row){return `<a href='#' onclick='endEditing();'>${val}</a>`}">按钮linkbutton</th>
