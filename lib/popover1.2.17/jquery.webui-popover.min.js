...
function(a, b, c) {
    ...
    function(b) {
        ...
        // d is jQuery
        function getTrans(item){ //hisui translate
            if(d && d.hisui && d.hisui.getTrans) return d.hisui.getTrans(item);
            return item;
        };
        function getZIndex(){ //hisui zindex
            //$.fn.window.defaults.zIndex
            if(d && d.fn && d.fn.window && d.fn.window.defaults && d.fn.window.defaults.zIndex) {
                d.fn.window.defaults.zIndex++;
                return d.fn.window.defaults.zIndex;s
            }
            return 8999;
        };
        function e(a, b) {
        ...
        e.prototype = {
            ...
            show: function() {
                if (!this._opened) {
                    var a = this.getTarget().removeClass().addClass(g).addClass(this._customTargetClass).css('zIndex',getZIndex()); //zIndex inc auto cryze 2020-04-23
            ...
            setTitle: function(a) {
                ...
                a ? ("rtl" !== this.options.direction || b.hasClass(j) || b.addClass(j), b.html(getTrans(a))) : b.remove() //add trans
            },
            hasContent: function() {
            ...
            setContent: function(a) {
                ...
                c = this.getContentElement();
                "string" == typeof a ? c.html(getTrans(a)) : a instanceof d && (c.html(""), this.options.cache ? a.removeClass(g + "-content").appendTo(c) : a.clone(!0, !0).removeClass(g + "-content").appendTo(c)),  //add trans string content 
                this.$target = b
            },
            isAsync: function() {
