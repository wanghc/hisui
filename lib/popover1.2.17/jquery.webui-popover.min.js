...
function(a, b, c) {
    ...
    function(b) {
        ...
        function getTrans(item){ //hisui translate
            if(d && d.hisui && d.hisui.getTrans) return jQuery.hisui.getTrans(item);
            return item;
        };
        function getZIndex(){ //hisui zindex
            //$.fn.window.defaults.zIndex
            if(d && d.fn && d.fn.window && $.fn.window.defaults && $.fn.window.defaults.zIndex) {
                $.fn.window.defaults.zIndex++;
                return $.fn.window.defaults.zIndex;
            }
            return 8999;
        };
        function e(a, b) {
