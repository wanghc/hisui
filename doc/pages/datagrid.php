			...
			$(function(){
				$HUI.datagrid('#mytable3',{
					...
					columns:[[
						...
						{field:'desc',title:'说明',width:332,showTip:true,tipWidth:450,tipTrackMouse:true,styler: function(value,row,index){
...
&lt;table id="dg6">&lt;/table></code></pre>
	...
	配置<code>bodyCls:'datagrid-body-padding7'</code>可以为行上添加内边距
	<div class="demo-exp-code entry-content"> 
			...
			<script type="text/javascript" class="use-prettyprint hide lang-js">
				$(function(){
					$HUI.datagrid('#mytable10',{
						autoSizeColumn:false,
						fitColumns:true,idField:'id',
						bodyCls:'table-splitline-btm-hidden datagrid-body-padding7',
