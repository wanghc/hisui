...
<head>
    ...
    <style>
        ...
        .iconlist, .fontlist, .arrowlist, .bigiconlist, .chinCharlist , .paneliconlist {
            display: inline-block;
        }
        .bigicon{
            height: 40px;
...
<body>
    ...
    <div class="hisui-panel" title="面板图标(16*16)" data-options="headerCls:'panel-header-card',titleWidth:100" style="padding:10px;margin-bottom:10px;">
        <ul class="paneliconlist"></ul>
    </div>
    <!-- <div class='line'></div> -->
    <div class="hisui-panel" id="bigIconPanel" title="大图标(28*28)" data-options="headerCls:'panel-header-card',titleWidth:100" style="padding:10px;margin-bottom:10px;">
    ...
    <script type="text/javascript">
        $(function(){
            ...
            var papericons = [
                ...
                ,'paper-thumb','paper-adm-pen','message-diag','note-pen','paper-ques','paper-key','paper-group','paper-clock-bue'
            ];
            //icons.sort();
            ...
            'stacked-diag','rose-diag','curve-diag','thermal-diag','bar-diag','bar-graph','cloud-chart','chart-pie','chart-bar','chart-doughnut','chart-radar'];
            ...
            ,'complex-word','list-word','private-word','public-word','text-word','translate-word','sort','out','change','macpw','macpworder','evaluate-red','evaluate-green','quality','mass-injury','gcp','implant','priority'];
            ...
            for(var i=0;i<panelicons.length;i++){
                $(
                    '<li>\
                    <span class="icon icon-'+panelicons[i]+'">icon-'+panelicons[i]+'</span>\
                    </li>'
                ).appendTo(".paneliconlist");
            }
            //----
            var bigicons = [
            ...
            ['upload-img','collect-img','capture-img'],
            ['font-size','insert-spec','prev-diag','molecular-order','tec-order','spec-clean','print-slides','material-coll']
        ];
            //bigicons.sort();
