...
<head>
	...
	<div class="use-prettyprint" prettyprintfor="#mydg1codehtml">
		...
		<tr>
			...
			<th data-options="field:'active2',width:60,align:'center',editor:{type:'switchbox',options:{width:51,onClass:'primary',offClass:'gray',onText:'开启',offText:'关闭'}}">开关switchbox</th>
