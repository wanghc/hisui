...
<head>
	...
	<script type="text/javascript" src="../../src/hisui.js"></script> 
</head>
<body data-theme="bgseablue">
	<style>	
		.hisui-panel td{padding:5px 0;}
		.hisui-panel td.r-label{padding-right: 10px;}
    </style>
    <h2>输入框样式集合</h2>
		<div class="hisui-panel" title="输入框样式示例" style="width:1260px;padding:10px;"
			...
			<table cellpadding="0">
				<tr>
					<td></td>
					<td><a class="hisui-popover" data-options="placement:'bottom-right',title:'关于',content:'这里是提示内容',style:'inverse'" >下右反色</a></td>
					<td><a class="hisui-popover" data-options="placement:'bottom',title:'关于',content:'这里是提示内容'" >正下</a></td>
					<td><a class="hisui-popover" data-options="placement:'bottom-left',title:'关于',content:'这里是提示内容'" >下左</a></td>
				</tr>
				<tr>
					<td></td>
					<td><a class="hisui-popover" data-options="placement:'top-right',title:'关于',content:'这里是提示内容'" >上右</a></td>
					<td><a class="hisui-popover" data-options="placement:'top',title:'关于',content:'这里是提示内容'" >正上</a></td>
					<td><a class="hisui-popover" data-options="placement:'top-left',title:'关于',content:'这里是提示内容'" >上左</a></td>
				</tr>
				<tr>
					<td></td>
					<td><a class="hisui-popover" data-options="placement:'right-top',title:'关于',content:'这里是提示内容'" >右上</a></td>
					<td><a class="hisui-popover" data-options="placement:'right',title:'关于',content:'这里是提示内容'" >正右</a></td>
					<td><a class="hisui-popover" data-options="placement:'right-bottom',title:'关于',content:'这里是提示内容'" >右下</a></td>
				</tr>
				<tr>
					<td></td>
					<td><a class="hisui-popover" data-options="placement:'left-top',title:'关于',content:'这里是提示内容'" >左上</a></td>
					<td><a class="hisui-popover" data-options="placement:'left',title:'关于',content:'这里是提示内容'" >正左</a></td>
					<td><a class="hisui-popover" data-options="placement:'left-bottom',title:'关于',content:'这里是提示内容'" >左下</a></td>
				</tr>
				<tr>
					<td></td>
					<td><a class="hisui-popover" data-options="placement:'bottom-right',title:'',content:'无标题有间距',padding:true" >下右1</a></td>
					<td><a class="hisui-popover" data-options="placement:'bottom',title:'',content:'无标题有间距',padding:true" >正下</a></td>
					<td><a class="hisui-popover" data-options="placement:'bottom-left',title:'',content:'无标题有间距',padding:true" >下左1</a></td>
				</tr>
                <tr>
					<td class="r-label required-label">序号验证框</td>
					<td>
						<input id="vapatno" class="textbox hisui-inputclearbtn" data-options="onClearBefore:function(val){alert('清空内容before：'+val)}">
						<a id="vabtn1" href="#" class="hisui-linkbutton">赋值</a><a id="vabtn" href="#" class="hisui-linkbutton" style="margin-left: 5px;">验证序号</a>
					</td>
				<!--</tr>
                <tr>-->
					<td class="r-label required-label">患者姓名验证框</td>
					<td>
						<input class="hisui-validatebox textbox hisui-inputclearbtn" data-options="required:true,validType:'length[3,10]'">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input class="hisui-validatebox textbox" data-options="required:true,validType:'idcard',tipPosition:'bottom'">
					</td>
				<!--</tr>
                <tr>-->
					<td class="r-label required-label">手机号验证框</td>
					<td>
                        <input class="hisui-validatebox textbox" data-options="required:true,validType:'mobilephone',tipPosition:'left'">
				...
				<tr>
					...
					<td>
						<input id="ss" class="hisui-searchbox textbox hisui-inputclearbtn" data-options="width:155"/>
                ...
                <tr>-->
					...
					<td>
						<input class="hisui-numberbox textbox hisui-inputclearbtn" data-options="precision:2,fix:false,max:200,min:0,required:true">
					</td>
				</tr>
				<tr>
					<td class="r-label">数字框</td>
					<td>
                        <input class="hisui-numberbox textbox hisui-inputclearbtn" data-options="isKeyupChange:true,width:155" id="nunb">
                ...
                <tr>-->
					...
					<td>
						<input name="default" class="hisui-triggerbox textbox hisui-inputclearbtn" data-options="handler:trmsg" />
					</td>
				</tr>
				<tr>
					<td class='r-label'>图片触发框</td>
					<td>
						<input id="trimg" name="img" class="hisui-triggerbox textbox  hisui-inputclearbtn"
                ...
                <tr>-->
					...
					<td>
						<input id="trcard" name="card" class="hisui-triggerbox textbox  hisui-inputclearbtn"
				...
				<tr>
					...
					<td>
						<input id="trcopy" name="copy" class="hisui-triggerbox textbox hisui-inputclearbtn"
							data-options="icon:'icon-copy-blue',handler:trmsg,plain:true" />
                ...
                <tr>-->
                    ...
                    <td>
                        <input id="dasamth" class="hisui-datebox textbox  hisui-inputclearbtn" data-options='onSelect:daonSelect,
                ...
                <tr>
                    ...
                    <td>
                        <input id="dadb" class="hisui-datebox textbox hisui-inputclearbtn" data-options='onSelect:daonSelect'/>
                ...
                <tr>-->
                    ...
                    <td>
                        <input class="hisui-datebox textbox hisui-inputclearbtn" value="2020-02-17" data-options='required:true'/>
                ...
                <tr>
                    ...
                    <td>
                        <input class="hisui-datetimebox textbox hisui-inputclearbtn" data-options="onSelect:daonSelect"/>
                ...
                <tr>-->
                    ...
                    <td>
                        <input class="hisui-timespinner hisui-inputclearbtn" data-options="showSeconds:true,width:155" style="border-radius: 2px;">
                    </td>
                </tr>
                <tr>
                    <td class="r-label">空组合</td>
                    <td><input id="cocc" class="textbox" placeholder="空面板"></td>
                <!--</tr>
                <tr>-->
                ...
                <tr>
                    ...
                    <td>
                        <select id="cxstateBox" class="hisui-combobox hisui-inputclearbtn" name="state" style="width:155px;" data-options="enterNullValueClear:false,onSelect:cxselectHandler,blurValidValue:true">
					...
					<td>
						<input id="lookup1" class='textbox hisui-inputclearbtn '/>
					</td>
                </tr>
                <tr>
					...
					<td>
						<input class="hisui-dateboxq textbox hisui-inputclearbtn " data-options="formatter:function(date){var y = date.getFullYear(); var m = date.getMonth()+1;return y+'-'+m;},validParams:'YM'">
					</td>
                </tr>
                <tr>
					...
					<td>
						<input class="hisui-timeboxq textbox hisui-inputclearbtn " data-options='timeFormat:"HMS"'>
					</td>
				</tr>
                <tr>
					...
					<td><input data-options="showSeconds:false" class="hisui-datetimeboxq textbox hisui-inputclearbtn "></td>
				</tr>
                <tr>
					<td class="r-label">文件框</td>
					<td>
						<input class="hisui-filebox hisui-inputclearbtn" name="file1" data-options="width:212,plain:true" />
					</td>
				<!--</tr>
                <tr>-->
					<td class="label">excel文件框</td>
					<td>
						<input class="hisui-filebox hisui-inputclearbtn" name="file2"
				...
				<tr>
					...
					<td>
						<input class="hisui-filebox hisui-inputclearbtn" name="file4" style="width:212px;"
							data-options="multiple:true,plain:true,buttonText:'多选',prompt:'请选择文件(多选的哦..)'" />
					</td>
				</tr>
				<tr>
					<td class="r-label">开关</td>
					<td>
						<div class="hisui-switchbox" data-options="onText:'开',offText:'关',size:'mini',animated:true,onClass:'primary',offClass:'gray'">
						</div>						
					</td>
					<td>
						<div class="hisui-switchbox" data-options="onText:'开启',offText:'关闭',size:'small',animated:true">
						</div>
					</td>
					<td>
						<div class="hisui-switchbox" style="width:200px;" data-options="onText:'母婴组合显示',offText:'母婴拆分显示',size:'small',animated:true">
						</div>
					</td>
				</tr>
				<tr>
					<td class="r-label">开关禁用</td>
					<td>
						<div class="hisui-switchbox" data-options="onText:'开',offText:'关',size:'mini',disabled:true,checked:false,animated:true">
						</div>
					</td>
					<td>
						<div class="hisui-switchbox" data-options="onText:'开启',offText:'关闭',size:'small',disabled:true,animated:true">
						</div>
					</td>
					<td>
						<div class="hisui-switchbox" data-options="onText:'开启',offText:'关闭',size:'small',disabled:true,checked:false,animated:true">
						</div>
					</td>
				</tr>
				<tr>
					<td class="r-label">按钮</td>
					<td>
					...
					<td>
						<a href="#" class="hisui-linkbutton showicon" data-options="iconCls:'icon-w-find'">查询</a>
					</td>
				</tr>
			</table>
        </div>
        <script type="text/javascript">
			...
			$(function(){
				...
				$('#cocc').inputclearbtn({onClearBefore:function(e){console.log('before',e)}});
				$('#cocc2').inputclearbtn({onClearAfter:function(e){console.log('after',e)}});
                $('#cosp').appendTo(cc2Obj.panel());
                $('#cosp input').radio({onCheckChange:function(e,v){
                    var v = $(this).val();
