...
<body>
	...
	<div class="demo-exp-code entry-content"> 
        ...
        <a href="javascript:void(0)" class="hisui-menubutton hisui-no-icon-menubutton" data-options="menu:'#mm3'">操作</a>
...
&lt;/div&gt;</code></pre>
	...
	<div class="demo-exp-code entry-content"> 
		...
		<table id='mytb2' class="hisui-datagrid" title="病人列表" style="width:600px;height:240px" data-options="iconCls:'icon-panel-brand',headerCls:'panel-header-gray',pagination:true,
