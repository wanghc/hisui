...
<table>
    <tr>
        ...
        <td id="eatlist" class="fs0">
            ...
            <input class="hisui-radio" type="radio" label='脐橙' name='wantEat1' disabled value="disable1">
            <input class="hisui-radio" type="radio" label='樱桃' name='wantEat2' disabled checked value="disable2">
        </td>
        <td class="links">
